...
if (uiNamespace getVariable ["ivcs_output_group_chat", true]) then
{
    ...
    {
        case "assign_color": {("airs" callExtension ["replace", [localize "STR_A3___1_1____2", "%1.1", "%1"]])#0};
        case "cancel_target": {("airs" callExtension ["replace", [localize "STR_A3___1_1___CANCEL_TARGET", "%1.1", "%1"]])#0};
        ...
        case "drop_bag": {("airs" callExtension ["replace", [localize "STR_A3___1_1___DROP_PACK", "%1.1", "%1"]])#0};
        case "eject": {("airs" callExtension ["replace", [localize "STR_A3___1_1___EJECT", "%1.1", "%1"]])#0};
        ...
        case "get_in_player";
        case "get_in": {("airs" callExtension ["replace", [localize "STR_A3___1_1___GET_IN", "%1.1", "%1"]])#0};
        case "get_out": {("airs" callExtension ["replace", [localize "STR_A3___1_1___DISMOUNT", "%1.1", "%1"]])#0};
        case "hold_fire": {("airs" callExtension ["replace", [localize "STR_A3___1_1___HOLD_FIRE", "%1.1", "%1"]])#0};
        case "land_helicopter": {localize "STR_IVCS_SYSTEMCHAT_LAND_HELICOPTER_1"};
        case "lasers_off": {("airs" callExtension ["replace", [localize "STR_A3___1_1___POINTERS_OFF", "%1.1", "%1"]])#0};
        case "lasers_on": {("airs" callExtension ["replace", [localize "STR_A3___1_1___POINTERS_ON", "%1.1", "%1"]])#0};
        case "lights_off": {("airs" callExtension ["replace", [localize "STR_A3___1_1___FLASHLIGHTS_OFF", "%1.1", "%1"]])#0};
        case "lights_on": {("airs" callExtension ["replace", [localize "STR_A3___1_1___FLASHLIGHTS_ON", "%1.1", "%1"]])#0};
        case "move_back_quick": {format[("airs" callExtension ["replace", [localize "STR_A3__MUNIT___MOVE____MGRPDIR_1", "%4.1", "%2"]])#0, "%1", localize "STR_A3_ARGUMENTS_DIRECTION_RELATIVE1_270_0"]};
        case "move_cursor": {localize "STR_IVCS_SYSTEMCHAT_MOVE_1"};
        case "move_distance_and";
        case "move_distance_point";
        case "move_distance": {("airs" callExtension ["replace", [localize "STR_A3__MUNIT___MOVE____MGRPDIR_1", "%4.1", "%2"]])#0};
        case "move_front_quick": {format[("airs" callExtension ["replace", [localize "STR_A3__MUNIT___MOVE____MGRPDIR_1", "%4.1", "%2"]])#0, "%1", localize "STR_A3_ARGUMENTS_DIRECTION_RELATIVE1_0_0"]};
        case "move_grid": {localize "STR_A3__MUNIT___MOVE___GRID___MGRID"};
        case "move_left_quick": {format[("airs" callExtension ["replace", [localize "STR_A3__MUNIT___MOVE____MGRPDIR_1", "%4.1", "%2"]])#0, "%1", localize "STR_A3_ARGUMENTS_DIRECTION_RELATIVE1_180_0"]};
        case "move_object";
        case "move_right_quick": {format[("airs" callExtension ["replace", [localize "STR_A3__MUNIT___MOVE____MGRPDIR_1", "%4.1", "%2"]])#0, "%1", localize "STR_A3_ARGUMENTS_DIRECTION_RELATIVE1_90_0"]};
        case "open_fire_red": {("airs" callExtension ["replace", [localize "STR_A3___1_1___FREE_TO_ENGAGE", "%1.1", "%1"]])#0};
        case "open_fire_white": {localize "STR_IVCS_SYSTEMCHAT_OPEN_FIRE_WHITE_1"};
        case "open_fire": {("airs" callExtension ["replace", [localize "STR_A3___1_1___OPEN_FIRE", "%1.1", "%1"]])#0};
        case "pos_auto": {("airs" callExtension ["replace", [localize "STR_A3___1_1___COPY_MY_STANCE", "%1.1", "%1"]])#0};
        case "pos_down": {("airs" callExtension ["replace", [localize "STR_A3___1_1___PRONE", "%1.1", "%1"]])#0};
        case "pos_middle": {("airs" callExtension ["replace", [localize "STR_A3___1_1___CROUCH", "%1.1", "%1"]])#0};
        case "pos_up": {("airs" callExtension ["replace", [localize "STR_A3___1_1___STAND", "%1.1", "%1"]])#0};
        case "regroup": {("airs" callExtension ["replace", [localize "STR_A3___1___REGROUP", "%1.1", "%1"]])#0};
        case "salute": {localize "STR_IVCS_SYSTEMCHAT_SALUTE_1"};
        case "scan_horizon": {("airs" callExtension ["replace", [localize "STR_A3___1_1___SCAN_HORIZON", "%1.1", "%1"]])#0};
        ...
        case "sitrep": {("airs" callExtension ["replace", [localize "STR_A3___1_1___SITREP", "%1.1", "%1"]])#0};
        case "stop": {("airs" callExtension ["replace", [localize "STR_A3___1_1___STOP", "%1.1", "%1"]])#0};
        case "suppressive_fire": {localize "STR_IVCS_SYSTEMCHAT_MOVE_1"};
        case "target_object": {("airs" callExtension ["replace", [localize "STR_A3_TARGET____1", "%1", "%2"]])#0};
        case "watch_cursor": {localize "STR_IVCS_SYSTEMCHAT_WATCH_1"};
        case "watch_direction": {("airs" callExtension ["replace", [localize "STR_A3___1_1___WATCH____2", "%1.1", "%1"]])#0};
        ...
        case "heal_other": {("airs" callExtension ["replace", [localize "str_a3___1_1___heal____2", "%1.1", "%1"]])#0};
    ...
    if (_text != "") then
    {
        private _leftText = ("airs" callExtension ["title_case", [_left joinString ", "]])#0;
        private _rightText = ("airs" callExtension ["title_case", [_right joinString " "]])#0;
