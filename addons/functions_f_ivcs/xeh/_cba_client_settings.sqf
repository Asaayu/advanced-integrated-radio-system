...
[
    ...
    {
        _this params ["_value"];
        "airs" callExtension ["set_minimum_required_confidence", [(_value/100)]];
    }
...
[
    ...
    {
        _this params ["_value"];
        "airs" callExtension ["set_initial_silence_timeout", [_value]];
    }
] call CBA_fnc_addSetting;
...
[
    ...
    {
        _this params ["_value"];
        "airs" callExtension ["set_end_silence_timeout_ambiguous", [_value]];
    }
] call CBA_fnc_addSetting;
...
[
    ...
    {
        _this params ["_value"];
        "airs" callExtension ["set_end_silence_timeout", [_value]];
    }
] call CBA_fnc_addSetting;
...
[
    ...
    {
        _this params ["_value"];
        "airs" callExtension ["set_end_babble_timeout", [_value]];
    }
] call CBA_fnc_addSetting;
