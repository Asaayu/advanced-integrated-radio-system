...
// Check the mission is valid
if is3DEN exitWith { "airs_client" callExtension "log:User opened 3den mission, client 'XEH_preinit' executed halted."; };
if !isMultiplayer exitWith { "airs_client" callExtension "log:User joined singleplayer game, client 'XEH_preinit' executed halted."; };
