...
namespace AdvancedIntegratedRadioSystem
{
    ...
    {
        private static readonly string GIT_REPO = "Asaayu/advanced-integrated-radio-system/main";
            ...
            try
            {
                ...
                using (HttpClient client = new HttpClient(new HttpClientHandler { UseDefaultCredentials = true }))
                {
                    ...
                    if (localVersion < remoteVersion)
                    {
                        string[] messageLines =
                        {
                            "A new version of 'Advanced Integrated Radio System' is available to download.",
